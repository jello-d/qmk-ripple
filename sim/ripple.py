...
def main():
    ...
    ap.add_argument("--hi", default="b400ff", help="highlight hex (purple)")
    ap.add_argument("--spread", type=float, default=3.0, help="ms delay per unit")
    ap.add_argument("--radius", type=float, default=34.0, help="reach, units")
    ap.add_argument("--fade", type=float, default=240.0, help="lit time ms")
